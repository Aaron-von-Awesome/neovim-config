...
vim.keymap.set("n", "<leader>tv", ":wincmd v<bar> Ex <bar> vertical resize 35<CR>", {noremap = true})
vim.keymap.set("n", "<leader>th", ":wincmd s<bar> Ex <bar> resize 25<CR>", {noremap = true})
